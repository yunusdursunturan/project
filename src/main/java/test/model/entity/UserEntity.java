...
public class UserEntity {
    ...
    public UserEntity(UserType user) {
        ...
        this.userLastName = user.getSurName();
        this.email = user.getEmail();
        this.cinsiyet = user.getCinsiyet();
        this.telefonId = user.getTelefonId();
        this.addressId = user.getAddressId();
        this.passwordId = user.getPasswordId();
        this.active = user.getActive().toString();
        this.medeniHaliKodu = user.getMedeniHaliKodu();
        this.cepTelefon = user.getCepTelefon();
        this.dogumTarihi = user.getDogumTarihi();
        this.meslek = user.getMeslek();
        this.sehir = user.getSehir();
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode( userId, userName, userLastName, email, cinsiyet, telefonId, addressId, passwordId, active, medeniHaliKodu, cepTelefon, dogumTarihi, meslek, sehir, postaKodu);
    }
}
